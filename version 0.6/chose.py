...
for question_choser_e in range(0,5):
    questions_chosen_e+=1
...
for question_choser_m in range(0,3):
    questions_chosen_m+=1
...
for question_choser_h in range(0,2):
    questions_chosen_h+=1
